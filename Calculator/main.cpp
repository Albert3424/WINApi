...
CONST INT g_i_DISPLAY_WIDTH = (g_i_BUTTON_SIZE + g_i_INTERVAL ) * 5 + g_i_INTERVAL * 4;
...
VOID SetSkin(HWND hwnd, CONST CHAR* skin)
{
	...
	for (int i = 0; i < 18; i++)
	{
		...
		(
			...
			sz_filename,
			IMAGE_BITMAP,
			i + IDC_BUTTON_0 == IDC_BUTTON_0 ? g_i_BUTTON_DOUBLE_SIZE : g_i_BUTTON_DOUBLE_SIZE,
