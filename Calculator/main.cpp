...
CONST COLORREF g_WINDOW_BACKGROUND[] = { RGB(0, 0, 150), RGB(100, 50, 50) };
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		...
		PathCombine(dllpath, filepath, ("Fonts\\Calculator.dll"));
	...
	case WM_CTLCOLOREDIT:
	{
		...
		if (GetDlgCtrlID(hEdit) == IDC_EDIT_DISPLAY)
		{
			...
			HBRUSH hbrBackground = CreateSolidBrush(g_DISPLAY_BACKGROUND[color_index]);
